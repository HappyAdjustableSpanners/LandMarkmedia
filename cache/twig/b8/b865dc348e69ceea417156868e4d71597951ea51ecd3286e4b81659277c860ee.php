...
class __TwigTemplate_a3d14b8e9ca632184096b2d7af008c34c06dbe909d366dadc517a16e964d4fdc extends Twig_Template
{
...
<ul class=\"pagination\">
    ";
            ...
            if ($this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : null), "hasPrev", array())) {
                // line 8
                echo "        ";
                $context["url"] = ((isset($context["base_url"]) ? $context["base_url"] : null) . twig_replace_filter(($this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : null), "params", array()) . $this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : null), "prevUrl", array())), array("//" => "/")));
                // line 9
...
$context["paginate"], "isInDelta", array())) {
                    // line 19
                    echo "            ";
                    $context["url"] = ((isset($context["base_url"]) ? $context["base_url"] : null) . twig_replace_filter(($this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : null), "params", array()) . $this->getAttribute($context["paginate"], "url", array())), array("//" => "/")));
                    // line 20
                    echo "            <li><a href=\"";
                    echo (isset($context["url"]) ? $context["url"] : null);
                    echo "\">";
...
$context["paginate"], "isDeltaBorder", array())) {
    ...
    ";
            ...
            if ($this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : null), "hasNext", array())) {
                // line 27
                echo "        ";
                $context["url"] = ((isset($context["base_url"]) ? $context["base_url"] : null) . twig_replace_filter(($this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : null), "params", array()) . $this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : null), "nextUrl", array())), array("//" => "/")));
                // line 28
...
{% endif %}
", "partials/pagination.html.twig", "C:\\wamp64\\www\\LandMarkmedia\\user\\plugins\\pagination\\templates\\partials\\pagination.html.twig");
    }
}
